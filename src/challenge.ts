export function challengeTest(a: string) {
    return a;
}
...
export function _21mergeTwoListsBetter(list1: ListNode | null, list2: ListNode | null): ListNode | null {
...
export function _21mergeTwoLists(list1: ListNode | null, list2: ListNode | null): ListNode | null {
    /*
    My idea here was:
    1. Assign the head. 
